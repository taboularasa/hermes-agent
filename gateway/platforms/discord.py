...
class DiscordAdapter(BasePlatformAdapter):
    ...
    def _register_slash_commands(self) -> None:
        ...
        try:
            ...
            for cmd_def in COMMAND_REGISTRY:
                ...
                auto_cmd = self._make_app_command(
                    name=discord_name,
                    description=desc,
                    callback=handler,
                )
    ...
    def _register_skill_group(self, tree) -> None:
        ...
        try:
            ...
            skill_group = self._make_app_group(
                name="skill",
            ...
            for cat_name in sorted(categories):
                ...
                cat_group = self._make_app_group(
                    name=cat_name,
    ...
    def _is_dm_channel(channel: Any) -> bool:
        """Return True for Discord DM channels, tolerating test monkeypatching."""
        ...
        try:
            ...
            pass
        return "dmchannel" in type(channel).__name__.lower()

    @staticmethod
    def _is_thread_channel(channel: Any) -> bool:
        """Return True for Discord thread channels, tolerating test monkeypatching."""
        ...
        try:
            ...
            pass
        return "thread" in type(channel).__name__.lower()

    @staticmethod
    def _make_app_command(*, name: str, description: str, callback, parent=None):
        """Create an app command, with a lightweight fallback for test stubs."""
        command_cls = getattr(getattr(discord, "app_commands", None), "Command", None)
    ...
    @staticmethod
    def _make_app_group(*, name: str, description: str, parent=None):
        """Create an app command group, with a lightweight fallback for test stubs."""
        group_cls = getattr(getattr(discord, "app_commands", None), "Group", None)
