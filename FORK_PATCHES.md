...
third sealing pass. `line range` is intentionally approximate for module-wide
...
| `run_agent.py` | `1-EOF` | agent runtime composition | Compatibility wrapper onto the sealed agent runner domain. | no |
...
| `trajectory_compressor.py` | `1-EOF` | trajectory compression | Compatibility wrapper onto the sealed trajectory compression domain. | no |
...
| `hermes_cli/status.py` | `1-EOF` | ctx.rs integration | Compatibility wrapper onto the sealed status CLI domain. | no |
...
| `tools/web_tools.py` | `1-EOF` | web provider routing | Compatibility wrapper onto the sealed web tooling domain. | no |
...
| `agent/anthropic_adapter.py` | `1-EOF` | provider/auth | Compatibility wrapper onto the sealed Anthropic adapter domain. | no |
