...
class AIAgent:
    ...
    def _codex_silent_hang_hint(self, model: Optional[str] = None) -> Optional[str]:
        ...
        return (
            ...
            "Workaround: try `gpt-5.4` on the same OAuth profile, or switch to a "
            "different model/provider in your fallback chain (e.g. the configured "
            "OpenRouter fallback). Note: `gpt-5.3-codex` is not supported on "
            "ChatGPT-account Codex sign-in and returns HTTP 400. "
