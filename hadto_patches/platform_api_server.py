...
class APIServerAdapter(BasePlatformAdapter):
    ...
    async def _handle_pause_job(self, request: "web.Request") -> "web.Response":
        ...
        try:
            ...
            pause_params = inspect.signature(self._cron_pause).parameters
            accepts_reason = (
                "reason" in pause_params
                or any(param.kind == inspect.Parameter.VAR_KEYWORD for param in pause_params.values())
            )
            if accepts_reason:
