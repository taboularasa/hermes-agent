...
_SLACK_TARGET_RE = re.compile(r"^\s*([CDG][A-Z0-9]{8,})(?::(\d+(?:\.\d+)?))?\s*$")
...
SEND_MESSAGE_SCHEMA = {
    ...
    "parameters": {
        ...
        "properties": {
            ...
            "target": {
                "type": "string",
                "description": "Delivery target. Format: 'platform' (uses home channel), 'platform:#channel-name', 'platform:chat_id', or 'platform:chat_id:thread_id' / 'platform:chat_id:thread_ts' for threaded platforms like Telegram, Discord, and Slack. Examples: 'telegram', 'telegram:-1001234567890:17585', 'discord:999888777:555444333', 'slack:C01234567:1740000000.123456', 'discord:#bot-home', 'slack:#engineering', 'signal:+155****4567', 'matrix:!roomid:server.org', 'matrix:@user:server.org'"
            },
            "message": {
                "type": "string",
                "description": "The message text to send. For Slack user mentions, prefer canonical <@U123ABC456> syntax; @U123ABC456 is normalized automatically."
            }
        },
        "required": []
    }
