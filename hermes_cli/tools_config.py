    ...
    if has_explicit_config:
        ...
        if composite_tools:
            ...
            for ts_key, _, _ in CONFIGURABLE_TOOLSETS:
                ...
                # not drop the whole toolset. See issue #49622. The Hadto helper
                # additionally keeps the legacy web_search/web_extract pair
                # sufficient for the "web" toolset (which gained web_search_matrix).
        ...
        for ts_key, _, _ in CONFIGURABLE_TOOLSETS:
            ...
            # toolset the moment a plugin/overlay/desktop tool joins it. The
            # Hadto helper additionally keeps the legacy web_search/web_extract
            # pair sufficient for the "web" toolset (which gained web_search_matrix).
            ts_tools = set(resolve_toolset(ts_key, include_registry=False))
