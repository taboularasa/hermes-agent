...
class TestGetToolset:
    ...
    def test_merges_registry_tools_into_builtin_toolset(self, monkeypatch):
        ...
        ts = get_toolset("web")
        assert ts is not None
        assert set(ts["tools"]) == {"web_search", "web_extract", "web_search_matrix", "web_search_plus"}
...
class TestResolveToolset:
    def test_leaf_toolset(self):
        ...
        assert set(tools) == {"web_search", "web_extract", "web_search_matrix"}
...
class TestDefaultPlatformWebSearchCoverage:
    def test_web_toolset_includes_provider_matrix(self):
        assert "web_search_matrix" in resolve_toolset("web")

    def test_hermes_cron_toolset_includes_provider_matrix(self):
        assert "web_search_matrix" in resolve_toolset("hermes-cron")
