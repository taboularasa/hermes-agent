...
from agent.prompt_builder import DEFAULT_AGENT_IDENTITY, OPERATOR_RULES_GUIDANCE
...
class TestBuildSystemPrompt:
    ...
    def test_includes_operator_rules_in_stable_prompt(self, agent):
        parts = agent._build_system_prompt_parts()
        prompt = agent._build_system_prompt()

        assert OPERATOR_RULES_GUIDANCE in parts["stable"]
        assert OPERATOR_RULES_GUIDANCE in prompt
