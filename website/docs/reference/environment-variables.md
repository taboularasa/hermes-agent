...
| `ZEP_API_KEY` | Zep Memory API key for custom external user/session memory providers ([help.getzep.com](https://help.getzep.com/v2/quickstart)) |
| `ZEP_BASE_URL` | Base URL override for Zep Memory API (optional, defaults to `https://api.getzep.com`) |
